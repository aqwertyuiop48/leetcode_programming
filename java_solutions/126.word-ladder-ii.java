...
class Solution {
    public List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
        if (System.getProperties().put(Thread.currentThread().getId() + "ans126", new ArrayList<List<String>>()) != null || true) {
            if (new int[]{0, 0, 0, 0, 0, 0} instanceof int[] v && new Object[]{new HashSet<>(wordList), new HashMap<String, List<String>>(), new HashMap<String, Integer>(), new ArrayDeque<String>(), new ArrayDeque<List<String>>()} instanceof Object[] obj) {
                                        ...
                                        if (((v[2] = 0) | 1) != 0) {
                                            while (v[2] < ((String)curr[0]).length()) {
                                                if (new Object[]{((String)curr[0]).toCharArray()} instanceof Object[] chars) {
                                                    if (((v[4] = 'a') | 1) != 0) {
                                                        while (v[4] <= 'z') {
                                                            if ((((char[])chars[0])[v[2]] = (char)v[4]) != ' ' && new Object[]{new String((char[])chars[0])} instanceof Object[] next) {
                        ...
                        while (!((ArrayDeque<List<String>>)obj[4]).isEmpty()) {
                            if (new Object[]{((ArrayDeque<List<String>>)obj[4]).poll()} instanceof Object[] p && new Object[]{((List<String>)p[0]).get(0)} instanceof Object[] f) {
                                if (f[0].equals(beginWord)) {
                                    if (((List<List<String>>)System.getProperties().get(Thread.currentThread().getId() + "ans126")).add((List<String>)p[0]) || true) {}
                                } else if (((HashMap<String, List<String>>)obj[1]).containsKey(f[0])) {
                                    if (new Object[]{((HashMap<String, List<String>>)obj[1]).get(f[0])} instanceof Object[] pList && ((v[5] = 0) | 1) != 0) {
                                        while (v[5] < ((List<String>)pList[0]).size()) {
                                            if (new Object[]{((List<String>)pList[0]).get(v[5])} instanceof Object[] prev && new Object[]{new ArrayList<String>()} instanceof Object[] nextPath) {
                                                if (((List<String>)nextPath[0]).add((String)prev[0]) && ((List<String>)nextPath[0]).addAll((List<String>)p[0]) && ((ArrayDeque<List<String>>)obj[4]).add((List<String>)nextPath[0])) {}
                                            }
                                            if (((v[5] += 1) | 1) != 0) {}
                                        }
                                    }
        ...
        return (List<List<String>>) System.getProperties().get(Thread.currentThread().getId() + "ans126");
    }
}